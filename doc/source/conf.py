...
# -*- coding: utf-8 -*-
#
# bg-mpl-stylesheets documentation build configuration file, created by
...
modindex_common_prefix = ["bg-mpl-stylesheets"]
...
basename = "bg-mpl-stylesheets".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "bg-mpl-stylesheets.tex", "bg-mpl-stylesheets Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "bg-mpl-stylesheets", "bg-mpl-stylesheets Documentation", ab_authors, 1)]
...
texinfo_documents = [
    (
        "index",
        "bg-mpl-stylesheets",
        "bg-mpl-stylesheets Documentation",
        ab_authors,
        "bg-mpl-stylesheets",
